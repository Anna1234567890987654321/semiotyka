...
plot_total <- ggplot(daily_vaccinations, aes(x = date, y = total_vaccinations)) +
  ...
  labs(x = "Date", y = "Total Vaccinations", title = "Total COVID-19 Vaccinations") +
  theme_minimal()

plot_daily <- ggplot(daily_vaccinations, aes(x = date, y = daily_vaccinations)) +
  geom_line(color = "green") +
  labs(x = "Date", y = "Daily Vaccinations", title = "Daily COVID-19 Vaccinations") +
  theme_minimal()

# Combine plots
combined_plot <- plot_total + plot_daily
combined_plot
```
...
top_countries_plot <- ggplot(top_countries, aes(x = reorder(location, -total_vaccinations), y = total_vaccinations)) +
  geom_bar(stat = "identity", fill = "skyblue") +
  labs(x = "Country", y = "Total Vaccinations", title = "Top 10 Countries by Total Vaccinations") +
...
- Several countries emerge as leaders in terms of total vaccinations, demonstrating the effectiveness of their vaccination campaigns.
